    ...
    def process(self):
        ...
        with open("./data/raw/data.txt", "r") as f:
            ...
            for i in range(num_graphs):
                ...
                str = lines[start_index].split(" ")
                num_nodes, num_edges = int(str[0]), int(str[1])
                ...
                for j in range(start_index + 1, end_index + 1):
                    ...
                    graph.append((s_i, s_l, d_i, d_l))
                # print(graph)
                edge_lists.append(graph)
        print(f"Read {len(edge_lists)} graphs")
        ...
        for index, edge_list in enumerate(edge_lists):
            ...
            node_list = [
                [label, 1] for label in node_list
            ]  # second param should be 0, 1, or 2
